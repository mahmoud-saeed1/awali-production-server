...
export type CreateBuildingTypeDTO = z.infer<typeof createBuildingTypeSchema>['body'];
export type UpdateBuildingTypeDTO = z.infer<typeof updateBuildingTypeSchema>['body'];
