...
function buildPermissions(actions: {
  create: boolean;
  read: boolean;
  update: boolean;
  delete: boolean;
...
// Only execute when run directly (e.g. `npm run seed`), not when imported by server.ts
